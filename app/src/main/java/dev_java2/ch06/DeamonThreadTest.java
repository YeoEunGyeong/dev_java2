 ...
 */
// DeamonThreadTest.java ; DeamonThreadTest.class, DeamonThreadTest$1.class(익명 클래스)
// Node.js, ES5,6,7 arrow function, 람다식 ; 최신 문법 < ?? 모르겠다 뭐지 왜 											
public class DeamonThreadTest { // 익명 클래스로 처리 < ??
    JButton jbtn = new JButton("전송");

    public DeamonThreadTest() {
        jbtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                System.out.println("전송 버튼 click~~");
            } // end actionPerformed
        });
    }
    ...
    public static void main(String[] args) {
        ...
        // setDaemon을 사용하여 옵션을 true로 주면 스레드와 상관없이 앱을 강제 종료
        // 프로그램에서 처리하는 것과 상관없이 별개로 동작해야 하면
        // 이 메소드를 호출하지 말거나 추가했다면 false로 설정
